...
function boundedCodePoints(minimum, maximum, label) {
...
export function projectMemoryEntry(entry, scope, confidence, provenance = []) {
...
export function projectHeuristic(heuristic) {
    const provenance = heuristic.evidence.map((item) => ({
